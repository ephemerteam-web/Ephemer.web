...
export default function CalendrierPage() {
  ...
  // ✅ NOUVEAU : saints dont un contact a le prénom
  ...
  return (
    <main className="min-h-screen bg-[#0a0118] p-4 md:p-8">
      <div className="max-w-6xl mx-auto">

        {/* Bouton retour */}
        <button
          onClick={() => router.push('/dashboard')}
          className="text-sm text-white/30 hover:text-white/70 mb-6 flex items-center gap-2 transition"
        >
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-7 gap-1.5">
                {jours.map((jour, idx) => {
                  ...
                  // ✅ On filtre : seulement les saints qui concernent un contact
          ...
          <div className="flex flex-col gap-4">
            ...
            {jourSelectionne && (
              <div className="bg-white/5 border border-white/10 rounded-3xl p-5 backdrop-blur-sm">
                ...
                {/* Saints - TOUS affichés, mis en valeur si contact concerné */}
                  ...
                  <div className="flex flex-col gap-2 max-h-64 overflow-y-auto pr-1">
                    {resultatsRecherche.map((saint, idx) => (
                      <div
                        key={idx}
                        onClick={() => {
                          // On navigue vers le mois/jour du saint
