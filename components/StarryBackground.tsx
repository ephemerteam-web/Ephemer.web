...
// ============================================================
// DÉCOR RÉUTILISABLE : Ciel étoilé + lune décorative
// À utiliser comme arrière-plan sur les pages du site
// children = le contenu qu'on met "par-dessus" le décor
// ============================================================
...
export default function StarryBackground({ children }: StarryBackgroundProps) {
  return (
    <main className="min-h-screen bg-[#0B1120] flex flex-col items-center relative overflow-hidden">
      ...
      {/* CONTENU DE LA PAGE (passé en children) */}
      {children}
    </main>
  )
}
